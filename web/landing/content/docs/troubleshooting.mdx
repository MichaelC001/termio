...
the front, so this usually heals by itself. To force it, press **Reinstall Hooks
and Skill** on the machine’s **Agents** page.
...
**Test** button that reports which of the four failures you have — see [Remote
...
See [The iPhone companion](/docs/iphone).
...
Notifications ▸ Termio**, and check that **Task notifications** is on under
**Settings ▸ General**.
...
machine and there is usually nothing left to ask.
