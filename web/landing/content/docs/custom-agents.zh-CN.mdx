...
x-i18n:
  ...
  source_hash: 32655b3343d9924d46e8208335ba0f3a582f01b9b1e1b7194164caefed9eabbf
...
工具装在哪里是一台设备的事实，所以命令路径设置在那台机器自己的页面上——本机用
**设置 ▸ Termio server**，其他机器用它在[远程主机](/zh-CN/docs/remote-hosts)下的那一行。
