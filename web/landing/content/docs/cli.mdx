...
description: The termio command — open a project from the shell, and the termio sessions orchestration API that lets you or another agent spawn, drive, and supervise sessions.
---
