...
//
// Layout: the animated terminal transcript is the whole point — it floats over
// a slow Paper dithering field (see OrchestrationDemo) and carries the story.
  ...
  return (
    <section id="orchestration" className="scroll-mt-24">
      <div className="mx-auto w-full max-w-6xl px-5 pb-32 pt-8 sm:px-8 sm:pb-40 sm:pt-10">
        ...
        <Reveal delayMs={80} className="mx-auto mt-12 w-full max-w-6xl">
          <OrchestrationDemo />
        </Reveal>
