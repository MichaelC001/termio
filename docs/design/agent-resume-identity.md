...
updated: 2026-07-16
related:
  - session-history-search-resume.md
  - agent-transcript-survey.md
...
`session-history-search-resume.md` §二 proposes a durable `agentSessionID` captured
...
seam is the natural home. `agent-transcript-survey.md` documents each agent's
