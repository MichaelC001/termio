...
Run from the repo root. Writes loose SVGs into Sources/termio/LangIcons/ (the
macOS bundle — NSImage decodes SVG natively), an asset catalog into
ios/Sources/LangIcons.xcassets (UIImage can't decode SVG at runtime, so iOS
ships them Xcode-compiled), and the shared catalog into
...
def main():
    ...
    lines = []
    lines.append("// Generated by scripts/gen_langicons.py — do not edit by hand.")
